...
import { 
  ...
  Share2, MessageSquare, FileText, Copy, Check, X
} from "lucide-react";
  ...
  return (
    <div className="h-screen flex flex-col bg-background overflow-hidden">
        ...
        <div className="flex items-center gap-2">
          <Dialog>
            <DialogTrigger asChild>
              <Button size="sm" variant="outline" className="border-white/10 bg-white/5 hover:bg-white/10 gap-2">
            ...
            <DialogContent className="bg-card border-white/10 sm:max-w-md">
              ...
              <div className="flex flex-col items-center gap-6 py-4">
                <div className="p-4 bg-white rounded-lg">
                  <QRCode value="https://secure.link/join/8x92" size={180} />
                </div>
      ...
      <main className="flex-1 flex flex-col md:flex-row overflow-hidden relative">
        ...
        {/* Visualizer / Status Area (Left/Top) */}
